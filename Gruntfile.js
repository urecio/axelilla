      ...
      bootstrap: {
        options: {
          patterns: [
            {
              match: /import "/g,
              replacement: 'import "bower_components/bootstrap/less/'
            }
          ]
        },
        files: [
          {
              ...
              dest: '<%= config.app %>/styles/bootstrap.less'
          },
          {
              src: ['<%= config.dist %>/styles/bootstrap.less'],
              dest: '<%= config.dist %>/styles/bootstrap.less'
          }
        ]
      }
    },
